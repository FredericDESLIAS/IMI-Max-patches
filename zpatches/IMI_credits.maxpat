{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 6.0, 44.0, 663.0, 484.0 ],
		"bglocked" : 0,
		"defrect" : [ 6.0, 44.0, 663.0, 484.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 271.0, 166.0, 226.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.0, 186.0, 207.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 142.0, 617.0, 69.0 ],
					"text" : "The patches that start with IMI were improved or entirely made by Nicolas Maréchal. Others were found on http://cycling74.com/forums/ or simplified\nhelp files from the original Max application."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 4.0, 656.0, 33.399673 ],
