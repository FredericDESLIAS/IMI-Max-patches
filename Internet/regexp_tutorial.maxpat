...
,
		"rect" : [ 1.0, 44.0, 416.0, 247.0 ],
		"bglocked" : 0,
		"defrect" : [ 1.0, 44.0, 416.0, 247.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.0, 98.0, 75.0, 16.0 ],
					"text" : "regexp_basics"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 8.0, 211.0, 55.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 33.0, 241.0, 21.0 ],
					"text" : "by Luke Hall ",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.0, 98.0, 89.0, 16.0 ],
					"text" : "regexp_cookbook"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 71.0, 211.0, 73.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 5.0, 405.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 152.0, 211.0, 42.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.0, 98.0, 72.0, 16.0 ],
					"text" : "about_regexp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.0, 122.0, 69.0, 18.0 ],
					"text" : "prepend load"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.0, 145.0, 52.0, 20.0 ],
					"text" : "pcontrol"
				}
...
,
						"rect" : [ 435.0, 45.0, 550.0, 650.0 ],
						"bglocked" : 0,
						"defrect" : [ 435.0, 45.0, 550.0, 650.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 164.0, 156.0, 77.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 124.0, 83.0, 21.0 ],
					"text" : "References"
				}
...
,
						"rect" : [ 436.0, 44.0, 550.0, 567.0 ],
						"bglocked" : 0,
						"defrect" : [ 436.0, 44.0, 550.0, 567.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 86.0, 156.0, 70.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"default_fontsize" : 12.0,
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 96.0, 75.0, 21.0 ],
					"text" : "Repetition"
				}
...
,
					"patching_rect" : [ 8.0, 156.0, 77.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"default_fontsize" : 12.0,
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 68.0, 78.0, 21.0 ],
					"text" : "Alternation"
				}
...
,
						"rect" : [ 430.0, 44.0, 551.0, 196.0 ],
						"bglocked" : 0,
						"defrect" : [ 430.0, 44.0, 551.0, 196.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 190.0, 130.0, 37.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"default_fontsize" : 12.0,
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 154.0, 61.0, 21.0 ],
					"text" : "The Dot"
				}
...
,
						"rect" : [ 441.0, 44.0, 558.0, 344.0 ],
						"bglocked" : 0,
						"defrect" : [ 441.0, 44.0, 558.0, 344.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 263.0, 175.0, 52.0, 18.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 263.0, 196.0, 92.0, 27.0 ],
					"text" : ";\rmax maxwindow"
				}
...
,
						"rect" : [ 426.0, 44.0, 556.0, 499.0 ],
						"bglocked" : 0,
						"defrect" : [ 426.0, 44.0, 556.0, 499.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 60.0, 130.0, 61.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"default_fontsize" : 12.0,
						"fontface" : 0,
...
,
						"rect" : [ 430.0, 44.0, 542.0, 343.0 ],
						"bglocked" : 0,
						"defrect" : [ 430.0, 44.0, 542.0, 343.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 8.0, 130.0, 49.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"default_fontsize" : 12.0,
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 124.0, 63.0, 21.0 ],
					"text" : "Anchors"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 96.0, 127.0, 21.0 ],
					"text" : "Character Classes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 68.0, 115.0, 21.0 ],
					"text" : "Character Types"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 4.0, 409.0, 52.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"hidden" : 1,
					"midpoints" : [ 271.5, 117.5, 271.5, 117.5 ],
					"source" : [ "obj-25", 0 ]
				}
